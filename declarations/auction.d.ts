...
declare namespace WoWAPI {
  ...
  type AUCTION_SALE_STATUS =
    | AUCTION_SALE_STATUS_UNSOLD
    | AUCTION_SALE_STATUS_SOLD;
  ...
  type AUCTION_HOUSE_FILTER_CATEGORY =
    | AUCTION_HOUSE_FILTER_CATEGORY_UNCATEGORIZED
  ...
  type AUCTION_HOUSE_SORT_ORDER =
    | AUCTION_HOUSE_SORT_ORDER_PRICE
    | AUCTION_HOUSE_SORT_ORDER_NAME
    | AUCTION_HOUSE_SORT_ORDER_LEVEL
    | AUCTION_HOUSE_SORT_ORDER_BID
    | AUCTION_HOUSE_SORT_ORDER_BUYOUT;

  type ITEM_COMMODITY_STATUS_UNKNOWN = 0;
  type ITEM_COMMODITY_STATUS_ITEM = 1;
  type ITEM_COMMODITY_STATUS_COMMODITY = 2;
  type ITEM_COMMODITY_STATUS =
    | ITEM_COMMODITY_STATUS_UNKNOWN
    | ITEM_COMMODITY_STATUS_ITEM
    | ITEM_COMMODITY_STATUS_COMMODITY;
  ...
  interface C_AuctionHouse {
    ...
    GetCommoditySearchResultInfo(
      itemId: number,
      commoditySearchIndex: number
    ): CommoditySearchResultInfo | null;
 ...
 */
declare function GetAuctionWowItemLink(
