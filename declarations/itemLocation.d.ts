declare namespace ItemLocation {
   ...
   * @since 8.0.1 (2018-07-17)
   */
  function CreateFromBagAndSlot(
    bagId: WoWAPI.CONTAINER_ID_BAG,
    slotIndex: number
  ): ItemLocationMixin;
   ...
   * @since 8.0.1 (2018-07-17)
   */
  function CreateFromEquipmentSlot(
    equipmentSlotIndex: WoWAPI.INVENTORY_SLOT_ID
  ): ItemLocationMixin;
}
