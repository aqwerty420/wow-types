declare namespace C_Item {
   ...
   * @since 8.0.1 (2018-07-17)
   */
  function DoesItemExistByID(
    itemInfo: WoWAPI.Hyperlink | string | number
  ): boolean;
  ...
  function DoesItemMatchBonusTreeReplacement(
    item: ItemLocation.ItemLocationMixin
  ): boolean;
   ...
   * @since 8.0.1 (2018-07-17)
   */
  function RequestLoadItemDataByID(
    itemInfo: WoWAPI.Hyperlink | string | number
  ): void;
