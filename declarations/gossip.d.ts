...
declare type QUEST_FREQUENCY =
  | QUEST_FREQUENCY_NORMAL
  | QUEST_FREQUENCY_DAILY
  | QUEST_FREQUENCY_WEEKLY;
 ...
 * @tupleReturn
 */
declare function GetGossipActiveQuests(): [
  string,
  string,
  boolean,
  boolean,
 ...
 * @tupleReturn
 */
declare function GetGossipAvailableQuests(): [
  string,
  number,
  boolean,
  QUEST_FREQUENCY,
